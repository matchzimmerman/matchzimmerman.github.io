...
version 42
__lua__
-- solar_system_v3.3.p8
-- daily pico-8 solar system iteration
-- changelog: orbit trails + ui brightness

function _init()
    -- sun and planet setup
    sun = {x=64, y=64, r=8, color=10}
    planets = {
...
function _draw()
    cls()
    -- sun
    circfill(sun.x, sun.y, sun.r, sun.color)
    -- orbit trails
    draw_trails()
    -- planets
    for p in all(planets) do
