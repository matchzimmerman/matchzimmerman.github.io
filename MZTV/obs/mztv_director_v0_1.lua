...
--
-- It never deletes scenes or sources. It only changes the transform/visibility
-- of the two source names you choose in the CURRENT scene.
...
local function set_rect(item, x, y, w, h, outer)
    ...
    obs.obs_sceneitem_set_alignment(item, bit.bor(obs.OBS_ALIGN_LEFT, obs.OBS_ALIGN_TOP))
    obs.obs_sceneitem_set_bounds_alignment(item, obs.OBS_ALIGN_CENTER)
